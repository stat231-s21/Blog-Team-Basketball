...
## Networks
<<<<<<< HEAD
Network science looks at connection. Specifically in these networks we are looking into the question - do more connected players have more successful NBA careers? Below we have attempted to build networks that allow you to visualize this phenomena. 
...
Bgg <- ggplot(data = Bnet
  ...
  geom_nodes(color = "firebrick2", size = 4) +
  theme_blank() +
  geom_nodetext(aes(label = name), nudge_x = 0.0, nudge_y = .07, check_overlap = TRUE) +
  geom_point_interactive(size=2) + 
  labs(
...
```
* The diameter of this network is `r diameter(B)`. 
*
...
```
* The diameter of this network is `r diameter(FG)`. 
*
...
```
* The diameter of this network is `r diameter(P)`. 
*
...
```
* The diameter of this network is `r diameter(R)`. 
*
...
```
* The diameter of this network is `r diameter(A)`. 
*
...
# get_diameter(cs0)
```
* The diameter of this network is `r diameter(cs0)`. 
*
