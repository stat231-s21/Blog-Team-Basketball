...
## Data Sources
The dataset we utilized for this investigation was scraped from basketball-reference.com. We scraped each team's roster from 2006-2021, which high school and college each player attended, and some relevant career statistics for each player. In total, 6616 instances of a player were scraped. 
